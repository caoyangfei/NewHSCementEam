...
public class YHGLStatisticsActivity extends BaseRefreshRecyclerActivity<YHEntity> implements YHGLStatisticsContract.View, WorkCountContract.View {
    ...
    protected IListAdapter<YHEntity> createAdapter() {
        yhglStatisticsAdapter = new YHGLStatisticsAdapter(this);
        return yhglStatisticsAdapter;
    }

    @Override
    protected int getLayoutID() {
        return R.layout.ac_yh_statistics;
    }
    ...
    protected void initData() {
        super.initData();
        titleText.setText("隐患统计");

        queryParam.put(Constant.BAPQuery.YH_DATE_START, DateUtil.dateFormat(getTimeOfMonthStart(), "yyyy-MM-dd 00:00:00"));
